...
def main():
    ...
    for i_episode in range(1, max_episodes+1):
        ...
        if running_reward_one > (log_interval*solved_reward):
            ...
            print('Episode {} \t avg length: {} \t reward_one: {}'.format(i_episode, avg_length, running_reward_one))
            print('Episode {} \t avg length: {} \t reward_two: {}'.format(i_episode, avg_length, running_reward_two))

            torch.save(ppo_one.policy.state_dict(), './PPOone_{}.pth'.format(env_name))
            torch.save(ppo_one.policy.state_dict(), './PPOtwo_{}.pth'.format(env_name))
            break
        # logging
