...
def test():
    ...
    for ep in range(1, n_episodes+1):
        ...
        for t in range(max_timesteps):
            ...
            ep_scores_one += scores_one["episode"]["r"]
            ep_scores_two += scores_two["episode"]["r"]
        ...
        print('Episode: {}\tReward_One: {}\t Scores_One:{}'.format(ep, int(ep_reward_one), int(ep_scores_one)))
        print('Episode: {}\tReward_Two: {}\t Scores_Two:{}'.format(ep, int(ep_reward_two), int(ep_scores_two)))
